...
RETURN:																//Rutin som används för BREQ i "LEFT" och "RIGHT" rutinen
		ret

UP:																	//Rutin som kollar ifall knappen UP har blivit nedtryckt och kollar vilket tecken som ska vara näst
		ld		r16,Z
		cpi		r16,'Z'
		breq	Z_TO_A												//Kollar rutinen för att kontrollera nästa tecken och sedan spara
		inc		r16
		st		Z,r16
		call	LCD_ASCII
		ldi		r16,0b00010000
...
DOWN:																//Rutin som kollar ifall knappen DOWN har blivit nedtryckt och kollar vilket tecken som ska vara näst
		ld		r16,Z
		cpi		r16,'A'
		breq	A_TO_Z												//Kollar rutinen för att kontrollera nästa tecken och sedan spara
		dec		r16
		st		Z,r16
		call	LCD_ASCII
		ldi		r16,0b00010000
...
DONE:																//Rutin för att kolla ifall vissa villkor är mötta
		ret
